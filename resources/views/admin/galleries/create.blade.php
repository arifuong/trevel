<x-layouts.admin :title="'Tambah Media Galeri — Admin Panel'">
    ...
    <div class="max-w-3xl mx-auto space-y-6"
        ...
        <div>
            <nav class="flex items-center gap-2 text-xs text-[#526057] mb-2">
                ...
                <svg class="w-3.5 h-3.5 text-zinc-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
                <span class="font-semibold text-[#12271E]">Tambah Media Baru</span>
            </nav>

            <h1 class="text-2xl sm:text-3xl font-bold text-[#12271E] tracking-tight">
                Tambah Foto atau Video Galeri
            </h1>
            <p class="text-xs sm:text-sm text-[#526057] mt-1">
                Unggah foto dokumentasi perjalanan jamaah atau tautkan sematan video YouTube.
            </p>
        </div>
            ...
            <form action="{{ route('admin.galleries.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div x-show="type === 'photo'" class="space-y-3">
                    <label for="image" class="block text-xs font-bold text-[#12271E] mb-1.5">
                        ...
                        <span class="text-xs font-normal text-[#526057]">(JPG, PNG, WEBP, Maks 5MB)</span>
                    </label>
                    <input type="file" 
                           name="image" 
                           id="image" 
                    ...
                    <template x-if="imagePreview">
                        <div class="mt-2 aspect-[4/3] max-w-sm rounded-xl overflow-hidden border border-[#E0E7DC] bg-[#EFF3EB]">
                ...
                <div x-show="type === 'video'" class="space-y-4" style="display: none;">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   ...
                                   id="video_url" 
                                   x-model="videoUrl"
                                   placeholder="Contoh: https://youtu.be/QrYcpXEC0RU atau https://www.youtube.com/watch?v=..."
                        ...
                        <p class="text-[11px] text-[#526057] mt-1.5">
                            Mendukung link pendek (<code>youtu.be</code>), link tonton lengkap, maupun Shorts.
                        </p>
                        @error('video_url')
                            <p class="text-xs text-red-600 mt-1 font-medium">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <p class="text-[11px] text-[#526057] mt-1">
                            Jika dikosongkan, sistem akan otomatis mengambil thumbnail resmi langsung dari YouTube.
                        </p>
                ...
                <div class="space-y-4 pt-2 border-t border-[#E0E7DC]">
                    ...
                    <div>
                        ...
                        <textarea name="caption" 
                                  ...
                                  class="w-full px-3.5 py-2.5 rounded-xl border border-[#E0E7DC] text-sm text-[#12271E] focus:outline-none focus:ring-2 focus:ring-[#1B3B2B]/20">{{ old('caption') }}</textarea>
                        @error('caption')
                            <p class="text-xs text-red-600 mt-1 font-medium">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" 
                                   ...
                                   class="w-full px-3.5 py-2.5 rounded-xl border border-[#E0E7DC] text-sm text-[#12271E] focus:outline-none focus:ring-2 focus:ring-[#1B3B2B]/20">
                            <p class="text-[11px] text-[#526057] mt-1">Angka lebih kecil tampil lebih awal (prioritas utama: 1).</p>
                        </div>

                        <div class="flex items-center pt-6">
                            <label class="inline-flex items-center gap-2.5 cursor-pointer">
                                <input type="checkbox" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="rounded border-zinc-300 text-[#1B3B2B] focus:ring-[#1B3B2B]">
