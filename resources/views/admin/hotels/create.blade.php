<x-layouts.admin title="Tambah Hotel">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6" style="animation: fadeSlideUp 0.4s ease both; animation-delay: 0.05s;">
            <div class="flex items-center text-sm text-[#526057] mb-4 gap-2">
                ...
                <span>/</span>
                <span class="text-[#1B3B2B] font-medium">Tambah Hotel Baru</span>
            </div>
            <h1 class="text-2xl font-bold text-[#122B1F]">Tambah Hotel Baru</h1>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-[#E0E7DC] shadow-xs overflow-hidden" style="animation: fadeSlideUp 0.4s ease both; animation-delay: 0.15s;" x-data="{
            ...
            facilities: {{ collect(old('facilities', []))->toJson() }},
            toggleFacility(id) {
                ...
                <div class="p-6 space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}" required
                                    ...
                                    placeholder="Contoh: Swissôtel Al Maqam">
                            </div>
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <select id="city" name="city" required class="w-full rounded-xl border border-[#E0E7DC] text-sm px-4 py-2.5 focus:ring-[#1B3B2B] focus:border-[#1B3B2B] outline-none transition-colors bg-white">
                                    ...
                                    <option value="Makkah" {{ old('city') == 'Makkah' ? 'selected' : '' }}>Makkah</option>
                                    <option value="Madinah" {{ old('city') == 'Madinah' ? 'selected' : '' }}>Madinah</option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <select id="star_rating" name="star_rating" required class="w-full rounded-xl border border-[#E0E7DC] text-sm px-4 py-2.5 focus:ring-[#1B3B2B] focus:border-[#1B3B2B] outline-none transition-colors bg-white">
                                    <option value="3" {{ old('star_rating') == '3' ? 'selected' : '' }}>3 Bintang</option>
                                    <option value="4" {{ old('star_rating') == '4' ? 'selected' : '' }}>4 Bintang</option>
                                    <option value="5" {{ old('star_rating') == '5' ? 'selected' : '' }}>5 Bintang</option>
                                </select>
                            </div>
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <div class="relative">
                                    <input type="number" id="distance_to_haram" name="distance_to_haram" value="{{ old('distance_to_haram') }}" min="0"
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="address" name="address" rows="2" 
                                    class="w-full rounded-xl border border-[#E0E7DC] text-sm px-4 py-2.5 focus:ring-[#1B3B2B] focus:border-[#1B3B2B] outline-none transition-colors"
                                    placeholder="Contoh: King Abdul Aziz Endowment, Ajyad Street, 21955 Makkah...">{{ old('address') }}</textarea>
                            </div>
                            ...
                            <div class="col-span-2">
                                ...
                                <textarea id="description" name="description" rows="4" 
                                    class="w-full rounded-xl border border-[#E0E7DC] text-sm px-4 py-2.5 focus:ring-[#1B3B2B] focus:border-[#1B3B2B] outline-none transition-colors"
                                    placeholder="Jelaskan gambaran umum tentang hotel ini...">{{ old('description') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Galeri Foto -->
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium text-[#122B1F] mb-2">Galeri Foto (Bisa pilih lebih dari satu)</label>
                                ...
                                <p class="text-xs text-[#526057] mt-2">Dapat memilih beberapa file sekaligus.</p>
                            </div>
                        </div>
                    </div>
