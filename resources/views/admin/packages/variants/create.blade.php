<x-layouts.admin>
    ...
    <form action="{{ route('admin.packages.variants.store', $package) }}" method="POST" enctype="multipart/form-data" class="space-y-6"
        ...
        <div class="bg-white rounded-2xl border border-[#E0E7DC] shadow-xs overflow-hidden" 
             x-data="{
                 prices: [
                     { room_type: 'quad', label: 'Kamar Kuad (Isi 4)', normal_price: '{{ old('prices.0.normal_price', '') }}', promo_price: '{{ old('prices.0.promo_price', '') }}', is_active: {{ old('prices.0.is_active', '1') == '1' ? 'true' : 'false' }}, has_promo: {{ old('prices.0.has_promo', '0') == '1' ? 'true' : 'false' }} },
                     { room_type: 'triple', label: 'Kamar Triple (Isi 3)', normal_price: '{{ old('prices.1.normal_price', '') }}', promo_price: '{{ old('prices.1.promo_price', '') }}', is_active: {{ old('prices.1.is_active', '1') == '1' ? 'true' : 'false' }}, has_promo: {{ old('prices.1.has_promo', '0') == '1' ? 'true' : 'false' }} },
                     { room_type: 'double', label: 'Kamar Double (Isi 2)', normal_price: '{{ old('prices.2.normal_price', '') }}', promo_price: '{{ old('prices.2.promo_price', '') }}', is_active: {{ old('prices.2.is_active', '1') == '1' ? 'true' : 'false' }}, has_promo: {{ old('prices.2.has_promo', '0') == '1' ? 'true' : 'false' }} }
                 ]
             }">
        ...
        <div class="bg-white rounded-2xl border border-[#E0E7DC] shadow-xs overflow-hidden"
            ...
            <div class="p-6">
                <div class="mb-4">
                    <p class="text-xs font-semibold text-[#12271E] mb-2">Pilih Maskapai <span class="text-red-500">*</span></p>
        ...
        <div class="bg-white rounded-2xl border border-[#E0E7DC] shadow-xs overflow-hidden"
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-2">
                    <label class="block text-xs font-semibold text-[#12271E]" for="hotel_makkah_id">Pilih Hotel Makkah <span class="text-red-500">*</span></label>
                ...
                <select id="hotel_makkah_id" name="hotel_makkah_id" x-model="hotelId" @change="fetchHotel" required
        ...
        <div class="bg-white rounded-2xl border border-[#E0E7DC] shadow-xs overflow-hidden"
            ...
            <div class="p-6">
                <div class="flex items-center justify-between mb-2">
                    <label class="block text-xs font-semibold text-[#12271E]" for="hotel_madinah_id">Pilih Hotel Madinah <span class="text-red-500">*</span></label>
                ...
                <select id="hotel_madinah_id" name="hotel_madinah_id" x-model="hotelId" @change="fetchHotel" required
                        class="w-full rounded-xl border border-[#E0E7DC] text-sm px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1B3B2B]/20 focus:border-[#1B3B2B] transition-colors bg-white">
