<x-layouts.main :title="'Hubungi Kami & Lokasi Kantor — PT. Zein Internasional'" :company="$company">
    ...
    ═══════════════════════════════════════════════════════════════ --}}
    <div class="bg-white border-b border-[#E5E7EB] pt-8 pb-14 sm:pb-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <x-breadcrumb :items="[['title' => 'Kontak & Lokasi Kantor']]" />

            <div data-reveal class="max-w-3xl mt-6 space-y-4">
                <span class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F4F7F2] border border-[#E5E7EB] text-[#1B3B2B] text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.25em]">
    ...
    {{-- ═══════════════════════════════════════════════════════════════
         2. KONTAK & FORM KONSULTASI (bg-white)
    ═══════════════════════════════════════════════════════════════ --}}
    <section class="py-16 sm:py-24 bg-white border-b border-[#E5E7EB]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                ...
                <div data-reveal class="lg:col-span-5 space-y-5">
                    ...
                    {{-- Card Alamat --}}
                    <div class="bg-white rounded-3xl p-6 sm:p-7 border border-[#E5E7EB] shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
                ...
                <div data-reveal class="lg:col-span-7">
                    <div class="bg-white rounded-3xl p-7 sm:p-9 border border-[#E5E7EB] shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]" x-data="{
                        name: '',
                        phone: '',
                        ...
                        <form @submit.prevent="sendWA" class="space-y-4">
                            <div>
                                ...
                                <input id="contact_name" type="text" x-model="name" required placeholder="Contoh: H. Ahmad Fauzi" 
                                       class="w-full px-4 py-3 rounded-xl border border-[#E5E7EB] text-xs sm:text-sm text-[#12271E] focus:border-[#1B3B2B] focus:outline-none bg-[#FBFDFB]">
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select id="contact_package" x-model="packageType" class="w-full px-4 py-3 rounded-xl border border-[#E5E7EB] text-xs sm:text-sm text-[#12271E] focus:border-[#1B3B2B] focus:outline-none bg-[#FBFDFB]">
                            ...
                            <div>
                                ...
                                <textarea id="contact_notes" x-model="notes" rows="3" placeholder="Contoh: Rencana berangkat bersama keluarga 4 orang di bulan Syawal..." 
                                          class="w-full px-4 py-3 rounded-xl border border-[#E5E7EB] text-xs sm:text-sm text-[#12271E] focus:border-[#1B3B2B] focus:outline-none bg-[#FBFDFB]"></textarea>
                            </div>

                            <button type="submit" 
                                    class="w-full h-12 inline-flex items-center justify-center gap-2 px-6 rounded-full text-xs sm:text-sm font-semibold text-white bg-[#1B3B2B] hover:bg-[#132E22] transition-all duration-200 shadow-md hover:shadow-lg cursor-pointer">
            ...
            ═══════════════════════════════════════════════════════════ --}}
            <div data-reveal class="mt-14 bg-white rounded-3xl border border-[#E5E7EB] overflow-hidden shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)]">
